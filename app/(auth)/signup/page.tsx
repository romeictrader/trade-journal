...
export default function SignupPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "radial-gradient(ellipse at 50% 30%, #161616 0%, #0a0a0a 70%)", padding: "0 24px" }}>
      ...
      {/* Heading */}
      <h1 style={{ fontSize: 32, fontWeight: 700, color: "#fff", margin: "0 0 8px", textAlign: "center" }}>Create Account</h1>
      <p style={{ fontSize: 15, color: "#666", margin: "0 0 36px", textAlign: "center" }}>Start your trading journal today</p>
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 14 }}>
            <label style={{ display: "block", fontSize: 13, color: "#666", marginBottom: 7 }}>Email</label>
            <input
              type="email"
              value={email}
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{ display: "block", fontSize: 13, color: "#666", marginBottom: 7 }}>Confirm Password</label>
            <input
              type="password"
              value={confirm}
